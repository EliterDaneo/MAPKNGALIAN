	...
	<section class="content">
		<div class="container-fluid">
			<div class="card card-primary">
				...
				<!-- /.card-body -->
				<?php echo form_open_multipart('admin/tambahPengumuman'); ?>    
				<!-- form start -->
				<form role="form">
					<div class="card-body">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="isi_pengumuman" placeholder="Isi Pengumuman" cols="10" rows="10" required></textarea> 
						</div>
						<!-- /.card-body -->
