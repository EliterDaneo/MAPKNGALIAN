 				...
 				<div class="col-12">
 					<div class="card">
 						<div class="card-header">
 							<a href="<?=base_url('admin/AddSarpras')?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Tambah Data</a>
 						</div>
 						<div class="card-body">
 							<table id="example1" class="table table-bordered table-striped">
 								<thead>
 									<tr>
 										<th>No</th>
 										<th>Nama Sarana Prasarana Sekolah</th>
 										<th>Keterangan Sarana</th>
 								...
 								<tbody>
 									<?php $no=1; foreach ($sarpras as $key => $value) { ?>
 										<tr>
 											<td><?= $no++ ?></td>
 											<td><?= $value->nama_sarpras ?></td>
 											<td><?= $value->keterangan_sarpras ?></td>
 											<td><?= $value->keterangan_alat ?></td>
 											<td><img src="<?= base_url('assets/data/foto/sarpras/'. $value->foto) ?>" width="100px"></td>
 											<td><?= $value->tanggal ?></td>
 											<td><?= $value->nama_user ?></td>
 											<td>
 												<a href="<?= base_url ('Admin/EditSarpras') ?>" title="Edit"><i class="fas fa-edit text-warning"></i></a>
