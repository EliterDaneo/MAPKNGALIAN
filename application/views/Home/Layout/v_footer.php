	...
	<script src="<?= base_url()?>assets/depan-web/assets/js/contact.js"></script>
	<script src="<?= base_url()?>assets/depan-web/assets/plugins/easing/easing.js"></script>
	<script src="<?= base_url()?>assets/depan-web/assets/plugins/parallax-js-master/parallax.min.js"></script>
	<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCIwF204lFZg1y4kPSIhKaHEXMLYxxuMhA"></script>
	<script src="<?= base_url()?>assets/depan-web/assets/plugins/marker_with_label/marker_with_label.js"></script>
	<script src="<?= base_url()?>assets/depan-web/assets/js/blog_single.js"></script>
...
$(function() {
	...
	<script>
var mymap = L.map('mapid').setView([-7.505591, 109.822424], 13);
...
L.marker([-7.505591, 109.822424]).addTo(mymap)
    .bindPopup("MA PK MA'ARIF NGALIAN").openPopup();
	</script>
