        ...
        <div class="row">
            <div class="col">
                <div class="section_title_container text-center">
                    <h2 class="section_title">Daftar Siswa di MA PK Maarif Ngalian</h2>
            ...
            <div class="col-lg-3 col-md-6 team_col">
                <div class="team_item">
                    <div class="team_image"><img
                            src="<?= base_url ('assets/data/foto/user/img/siswa/'.$value->foto_siswa)?>" alt=""></div>
                    <div class="team_body">
                        <h4><?= $value->nama_siswa ?></h4>
                        <span><?= $value->jenis_kelas .' '. $value->nama_kelas ?></span>
