 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <a href="<?= base_url('admin') ?>" class="brand-link">
     <img src="<?= base_url() ?>assets/depan-web/assets/img/favicon.jpg" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: .8">
     <span class="brand-text font-weight-light">
       <marquee><?= $logo->nama_sekolah ?></marquee>
     </span>
   </a>
       ...
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
             <li class="nav-item">
               <a href="<?= base_url('guru/dashboardNilai'); ?>" class="nav-link">
         ...
         <li class="nav-item">
           <a href="<?= base_url('guru/profile') ?>" class="nav-link" data-toggle="modal" data-target="#logOutModal">
