...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?= base_url() ?>assets/belakang-web/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/data/DataTables/datatables.css">
</head>